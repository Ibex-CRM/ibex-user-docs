...
<Callout type="warning">
  The Performance Analyser handles sensitive data, including influencer CPMs, CPAs, and engagement rates. This data is primarily for internal use. Please ensure you have correct margins applied to any charts or data that you may use or show to clients.
</Callout>
